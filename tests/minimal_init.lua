...
local plenary_dir = os.getenv("PLENARY_DIR")
  or ensure_plugin("plenary.nvim", "https://github.com/nvim-lua/plenary.nvim")

-- Ensure telescope is available (for telescope tests)
local telescope_dir = os.getenv("TELESCOPE_DIR")
  or ensure_plugin("telescope.nvim", "https://github.com/nvim-telescope/telescope.nvim")
